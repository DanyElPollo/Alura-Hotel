...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
                    ...
                    txtValor.setText(String.valueOf(calcularPrecio(fechaEntrada, fechaSalida, 10000)));
                }
            }
        });
        ...
        btnsiguiente.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
                    Instant instant = txtFechaEntrada.getDate().toInstant();
                    LocalDate fechaEntrada = LocalDate.ofInstant(instant, ZoneId.systemDefault());
                    Instant instant2 = txtFechaSalida.getDate().toInstant();
                    LocalDate fechaSalida = LocalDate.ofInstant(instant2, ZoneId.systemDefault());
                    ReservaController r = new ReservaController();
                    r.seguirAHuesped(fechaEntrada, fechaSalida, txtValor.getText(), txtFormaPago.getSelectedItem().toString());
                    dispose();
    ...
    public static int calcularPrecio(LocalDate fechaEntrada, LocalDate fechaSalida, int precioPorDia) {
